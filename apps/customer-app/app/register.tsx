...
export default function RegisterScreen() {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      if (response.ok) {
        if (Platform.OS === 'web') alert("Account Created! Please login.");
  ...
  return (
    <View style={styles.container}>
      <Animated.View style={[styles.card, { opacity: fadeAnim, transform: [{ translateY: slideAnim }] }]}>
        ...
        <Text style={styles.subtitle}>Join us and start ordering premium food</Text>
        ...
        <TouchableOpacity style={styles.primaryButton} onPress={handleRegister} disabled={loading} activeOpacity={0.8}>
