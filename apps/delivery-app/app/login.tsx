...
export default function LoginScreen() {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Delivery Rider Login</Text>
      <Text style={styles.subtitle}>Enter your credentials (e.g. rider@test.com / password)</Text>
      ...
      <TouchableOpacity 
        ...
        disabled={loading}
      >
        <Text style={styles.buttonText}>{loading ? "Please wait..." : "Login to Deliver"}</Text>
      </TouchableOpacity>
    </View>
  );
}
